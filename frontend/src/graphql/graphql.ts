...
export type TaskDetailsQuery = { task: { id: string, title: string, description: string, kind: TaskKind, isDone: boolean, doneAt: string | null, completionOutcome: CompletionOutcome | null, priority: TaskPriority, dueAt: string | null, hasDueTime: boolean, startAt: string | null, endAt: string | null, isOverdue: boolean, timezone: string, project: { id: string, title: string, isDefault: boolean }, recurrenceRule: { interval: number, unit: RecurrenceUnit, mode: RecurrenceMode, keepDueTime: boolean } | null, labels: Array<{ id: string, title: string }> } | null };
...
export type WeekQuery = { week: { startsOn: string, endsOn: string, isComplete: boolean, days: Array<{ date: string, tasks: Array<{ id: string, title: string, description: string, kind: TaskKind, isDone: boolean, doneAt: string | null, completionOutcome: CompletionOutcome | null, priority: TaskPriority, dueAt: string | null, hasDueTime: boolean, startAt: string | null, endAt: string | null, isOverdue: boolean, timezone: string, project: { id: string, title: string, isDefault: boolean }, recurrenceRule: { interval: number, unit: RecurrenceUnit, mode: RecurrenceMode, keepDueTime: boolean } | null, labels: Array<{ id: string, title: string }> }>, projections: Array<{ dueAt: string, hasDueTime: boolean, sourceTask: { id: string, title: string, description: string, kind: TaskKind, isDone: boolean, doneAt: string | null, completionOutcome: CompletionOutcome | null, priority: TaskPriority, dueAt: string | null, hasDueTime: boolean, startAt: string | null, endAt: string | null, isOverdue: boolean, timezone: string, project: { id: string, title: string, isDefault: boolean }, recurrenceRule: { interval: number, unit: RecurrenceUnit, mode: RecurrenceMode, keepDueTime: boolean } | null, labels: Array<{ id: string, title: string }> } }> }>, issues: Array<{ code: PageIssueCode, message: string, projectId: string | null }> } };

export type WeekTaskFragment = { id: string, title: string, description: string, kind: TaskKind, isDone: boolean, doneAt: string | null, completionOutcome: CompletionOutcome | null, priority: TaskPriority, dueAt: string | null, hasDueTime: boolean, startAt: string | null, endAt: string | null, isOverdue: boolean, timezone: string, project: { id: string, title: string, isDefault: boolean }, recurrenceRule: { interval: number, unit: RecurrenceUnit, mode: RecurrenceMode, keepDueTime: boolean } | null, labels: Array<{ id: string, title: string }> };
